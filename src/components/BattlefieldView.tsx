...
export const BattlefieldView: React.FC<BattlefieldViewProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="w-full bg-[#121215] border border-zinc-800 rounded-2xl p-2.5 sm:p-4 shadow-lg select-none space-y-2.5 sm:space-y-3">
        ...
        {/* Auxiliary Row: Jump to Today (Right in RTL) & Night Owl Cutoff Badge (Left/Balanced) */}
        <div className={`flex items-center gap-2 pt-2 border-t border-zinc-800/80 ${isToday ? 'justify-center sm:justify-start' : 'justify-between'}`}>
          {!isToday && (
            <button
              type="button"
      ...
      {/* 1.5. Dynamic Day Content with Directional Micro-Slide (160ms) */}
